...
CREATE SPATIAL INDEX idx_base_stations_coords ON base_stations (x, y);
...
CREATE SPATIAL INDEX idx_mobile_stations_coords ON mobile_stations (last_known_x, last_known_y);
